...
import com.example.webflax.catalizator.config.JwtUtil;
import com.example.webflax.catalizator.domain.User;
import com.example.webflax.catalizator.service.UserService;
                ...
                userService.findByUsername(credentials.getFirst("username"))
                        ...
                        .map(userDetails ->
                                Objects.equals(credentials.getFirst("password"), userDetails.getPassword())
                                        ? ResponseEntity.ok(jwtUtil.generateToken(userDetails)) : UNAUTHORIZED
